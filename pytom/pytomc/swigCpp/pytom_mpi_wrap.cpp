...
/*-----------------------------------------------
              @(target):= _pytom_mpi.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__pytom_mpi

#else
#  define SWIG_init    init_pytom_mpi

#endif
#define SWIG_name    "_pytom_mpi"
...
SWIGINTERN PyObject *_wrap_isInitialised(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  bool result;
  
  if (!SWIG_Python_UnpackTuple(args, "isInitialised", 0, 0, 0)) SWIG_fail;
  {
    try {
      result = (bool)isInitialised();
    } catch (const std::exception& e) {
      SWIG_exception(SWIG_RuntimeError, e.what());
    }
  }
...
SWIGINTERN PyObject *_wrap_rank(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  int result;
  
  if (!SWIG_Python_UnpackTuple(args, "rank", 0, 0, 0)) SWIG_fail;
  {
    try {
      result = (int)rank();
    } catch (const std::exception& e) {
...
SWIGINTERN PyObject *_wrap_size(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  int result;
  
  if (!SWIG_Python_UnpackTuple(args, "size", 0, 0, 0)) SWIG_fail;
  {
    try {
      result = (int)size();
    } catch (const std::exception& e) {
...
SWIGINTERN PyObject *_wrap_send(PyObject *self, PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args, "send", 2, 2, swig_obj)) SWIG_fail;
  {
    std::string *ptr = (std::string *)0;
    int res = SWIG_AsPtr_std_string(swig_obj[0], &ptr);
    if (!SWIG_IsOK(res) || !ptr) {
      SWIG_exception_fail(SWIG_ArgError((ptr ? res : SWIG_TypeError)), "in method '" "send" "', argument " "1"" of type '" "std::string""'"); 
    }
    arg1 = *ptr;
...
SWIGINTERN PyObject *_wrap_receive(PyObject *self, PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args, "receive", 0, 0, 0)) SWIG_fail;
  {
    try {
      result = receive();
    } catch (const std::exception& e) {
...
SWIGINTERN PyObject *_wrap_finalise(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  
  if (!SWIG_Python_UnpackTuple(args, "finalise", 0, 0, 0)) SWIG_fail;
  {
    try {
      finalise();
    } catch (const std::exception& e) {
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { "isInitialised", _wrap_isInitialised, METH_NOARGS, NULL},
	 { "rank", _wrap_rank, METH_NOARGS, NULL},
	 { "size", _wrap_size, METH_NOARGS, NULL},
	 { "send", _wrap_send, METH_VARARGS, NULL},
	 { "receive", _wrap_receive, METH_NOARGS, NULL},
	 { "finalise", _wrap_finalise, METH_NOARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
