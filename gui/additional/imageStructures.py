...
from pytom.gui.additional.structures import PyTomClass
...
class Image(PyTomClass):
    ...
    def __init__(self, filename=None, boxCoords=[0,0,0], dims=[32,32,1],
        ...
        from pytom_volume import read as pytom_read
        from pytom_volume import vol
    ...
    def read(self, filename, boxCoords=[0, 0, 0], dims=[32, 32, 1]):
        ...
        self.data = pytom_read(filename, int(boxCoords[0]), int(boxCoords[1]), int(boxCoords[2]),
