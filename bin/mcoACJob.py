...
if __name__ == '__main__':
    ...
    helper = ScriptHelper(sys.argv[0].split('/')[-1], 
                          ...
                          options=[ScriptOption(['-p','--particleList'], 'Particle list : xml file storing information to all subvolumes', arg=True, optional=False),
                                   ...
                                   ScriptOption(['--startTemperature'], 'Start temperature : ', arg=True, optional=True),
                                   ScriptOption(['--annealingStep'], 'Annealing step : temperature drop ', arg=True, optional=True),
                                   ScriptOption(['-n','--numberRefinementIterations'], 'Number of local refinement iterations', arg=True, optional=False),
