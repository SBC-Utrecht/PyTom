...
from pytom.tompy.structures import PyTomClass
...
class xcfScore(Score):
    ...
    def __init__(self, value=None):
        ...
        """
        from pytom.tompy.correlation import xcf, xcc
...
class nxcfScore(Score):
    ...
    def __init__(self, value=None):
        ...
        @param value: Current value of score
        """
        from pytom.tompy.correlation import nXcf, nxcc
...
def wXCCWrapper(self, volume, reference, mask=None):
    from pytom.tompy.correlation import weightedXCC
...
class RScore(Score):
    ...
    def __init__(self, value=None):
        from pytom.tompy.correlation import nXcf, weightedXCC
...
def FSCWrapper(self, volume, reference):
    from pytom.tompy.correlation import FSCSum
...
class SOCScore(Score):
    ...
    def __init__(self):
        from pytom.tompy.correlation import soc
