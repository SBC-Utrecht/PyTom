...
class pytom_FilterTest(unittest.TestCase):
    ...
    def correlation_Test(self):
        ...
        assert p[0] == 16 and p[1] == 16 and p[2] == 16


    def bandpassFilter_Test(self):
    ...
    def runTest(self):
        self.wedgeFilter_Test()
        self.wedgeRotation_Test()
        self.bandpassFilter_Test()
        self.ones_Test()
        self.ramp_Test()
        self.complexDiv_Test()
        self.profile_Test()
